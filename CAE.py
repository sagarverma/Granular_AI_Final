...
tflearn.config.init_graph (seed=101, log_device=False, num_cores=8, gpu_memory_fraction=0.5, soft_placement=True)
...
def load_data():
    ...
    return image_preloader(TRAINING_DATA_FILE, image_shape=IMAGE_INPUT_SIZE,
                           mode='file', filter_channel=True,
                           normalize=True)
